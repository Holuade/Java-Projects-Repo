...
public class AddStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        staffid.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NCE/ND", "BSc/HND", "Master", "PhD", "Others" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(staffid, javax.swing.GroupLayout.DEFAULT_SIZE, 236, Short.MAX_VALUE)
                            .addComponent(fname)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        date = sdt.format(jDateChooser1.getDate());
        String gen = (String)gender.getSelectedItem();
        String home = address.getText();
        String edu = (String)status.getSelectedItem();
        
        try{
            Connection conn = ConnectionProvider.getCon();
            Statement stm = conn.createStatement();
            stm.executeUpdate("insert into addstaff values ('" + id + "', '" + name + "', '" + post + "', "
                    + "'" + contactno + "','" + date + "', '" +gen + "', '" + home + "','" + edu + "')");
            if(id.equals("")){
           ...
           new AddStaff().setVisible(true);
             ...
             JOptionPane.showMessageDialog(null, "Please enter data in the correct format and fill all fields\nI!");
        }

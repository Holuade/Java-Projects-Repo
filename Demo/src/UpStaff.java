...
public class UpStaff extends javax.swing.JFrame {

    /**
     * Creates new form UpStaff
     */
    public UpStaff() {
        initComponents();
          ...
          ResultSet rst = stm.executeQuery("select * from addstaff where staffid = '" + id + "'");
           ...
           if(rst.next()){
              ...
              jTextField1.setEditable(false);
                ...
                JOptionPane.showMessageDialog(null, "Staff name does not exist");
                    setVisible(false);
                    new UpStaff().setVisible(true);  
                  }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Connection conn = ConnectionProvider.getCon();
            Statement stm = conn.createStatement();
            stm.executeUpdate("UPDATE `addstaff` SET Name = '" + fname + "', Post = '" + post + "', ContactNo = '" + contact + "', DOB = '"+ date + "', Gender = '" + gender + "', Address = '" + home + "', '" + " Status = '" + status + "' WHERE StaffID = '" + id + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
